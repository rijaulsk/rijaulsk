...
export default function Hero() {
  ...
  const handleMouseLeave = (
    buttonRef: React.RefObject<HTMLDivElement | null> // <--- Added "| null" here
  ) => {
    if (!buttonRef.current) return;
  ...
  return (
    <section
      id="home"
      className="relative w-full bg-background pt-16 md:pt-20 overflow-hidden"
    >
      {/* Custom Cursor Glow */}
      <div
      ...
      {mounted && (
        <>
          ...
          <div className="absolute bottom-[15%] left-[20%] animate-spin-slow">
            ...
            >
              <path
                d="M25 5 L27 20 L40 15 L30 25 L45 30 L30 35 L35 48 L25 38 L15 48 L20 35 L5 30 L20 25 L10 15 L23 20 Z"
                fill="currentColor"
                className="text-primary"
              />
            </svg>
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-4rem)] md:min-h-[calc(100vh-5rem)] max-w-7xl flex-col items-center justify-center px-6 py-16 md:py-20 text-center">
        ...
        <p className="mt-6 max-w-3xl text-xl leading-relaxed text-foreground/80 md:text-2xl animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-200">
          ...
          <span className="text-primary font-semibold">UI/UX</span> →{" "}
          <span className="text-primary font-semibold">Development</span> →{" "}
          <span className="text-primary font-semibold">SEO</span> →{" "}
          <span className="text-primary font-semibold">Deployment</span>
        </p>
